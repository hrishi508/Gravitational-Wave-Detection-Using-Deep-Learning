...
| ----- | ------------------ | --------------------- | -------------- | ----------- | -------------- |
| 3     | BNS signal + Noise | IMRPhenomPv2_NRTidal  | 5000           | N1          | S1             |
| ----- | ------------------ | --------------------- | -------------- | ----------- | -------------- |
```
...
|        | Accuracy | Precision | Recall | F1 Score | Accuracy | Precision | Recall | F1 Score |
| ------ | -------- | --------- | ------ | -------- | -------- | --------- | ------ | -------- |
| 1      | 66.62%   | 0.667     | 0.999  | 0.800    | 53.10%   | 0.516     | 1      | 0.681    |
| ------ | -------- | --------- | ------ | -------- | -------- | --------- | ------ | -------- |
```
...
|        | Accuracy | Precision | Recall | F1 Score | Accuracy | Precision | Recall | F1 Score |
| ------ | -------- | --------- | ------ | -------- | -------- | --------- | ------ | -------- |
| 1      | 52.70%   | 0.619     | 0.780  | 0.690    | 5.13%    | 0.026     | 1      | 0.051    |
| ------ | -------- | --------- | ------ | -------- | -------- | --------- | ------ | -------- |
```
